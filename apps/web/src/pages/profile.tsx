        ...
        return (
            <div className="flex h-full min-h-[calc(100vh-64px)] w-full items-center justify-center bg-black/50">
                <div className="mx-auto w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
                    ...
                    <Link
                        to="/login"
                        className="inline-block w-full rounded bg-[var(--color-primary)] px-4 py-2 text-center text-[var(--color-text-on-primary)] hover:bg-[var(--color-primary-hover)] font-semibold"
                    >
                        Go to Log In
                    </Link>
                </div>
