...
export default function ChatPanel({
    ...
    return (
        <div className="flex h-full w-full flex-col border-l border-border">
                            ...
                            >
                                <div
                                    className={`max-w-[75%] rounded-lg px-3 py-2 text-sm font-medium break-words ${
                                        isMine
                                            ? "bg-primary text-on-primary drop-shadow-sm"
            ...
            {/* Message input */}
            <div className="m-2 mt-0 flex items-center gap-2 bg-background p-2">
                <input
                    type="text"
                ...
                <button
                    ...
                    className="rounded bg-primary px-4 py-2 text-sm font-semibold text-on-primary transition-opacity disabled:opacity-40"
                >
                    Send
                </button>
            </div>
