    ...
    return (
        <aside className="flex flex-col border-r border-border bg-background p-4">
            ...
            <input
                ...
                className="mb-4 rounded bg-surface-alt px-3 py-2 text-sm text-black outline-none placeholder:text-black"
            />
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                {!loading && filtered.length === 0 && (
                    <div className="rounded bg-surface p-3 text-sm text-black">
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                {(convo.unread_count ?? 0) > 0 && convo.id !== activeId && (
                                    <span className="ml-2 flex h-5 min-w-5 items-center justify-center rounded-full bg-primary px-1.5 text-xs font-bold text-on-primary">
                                        {convo.unread_count}
                                    </span>
                                )}
                            </div>
