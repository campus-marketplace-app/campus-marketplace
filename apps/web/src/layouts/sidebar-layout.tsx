...
export default function SidebarLayout() {
  ...
  const [listingCondition, setListingCondition] =
    useState("LISTINGS.condition");
  const [listingDate, setListingDate] = useState(getCurrentDateTimeLocal);
  const [listingDescription, setListingDescription] = useState(
    "LISTINGS.description",
  );
  const [listingImageLabel, setListingImageLabel] = useState(
          ...
          <div className="relative z-10 mx-4 w-full max-w-4xl rounded-sm bg-[#a50f1a] p-6 shadow-lg sm:p-10">
            ...
            >
              <div className="mx-auto w-full max-w-sm">
                <label
                  htmlFor="title"
                  className="mb-2 block text-center text-sm font-semibold uppercase tracking-wide text-white"
                >
                  Title
                </label>
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label
                        htmlFor="price"
                        className="mb-2 block text-xs font-semibold uppercase tracking-wide text-white"
                      >
                        Price
                      </label>
                      <input
